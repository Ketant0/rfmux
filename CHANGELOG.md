...
* **periscope:** unified tabbed interface with dockable panels ([#44](https://github.com/Ketant0/rfmux/issues/44)) ([7cb76c7](https://github.com/Ketant0/rfmux/commit/7cb76c7b9a0b46f6aa4b617916ce313f710497bb))


### Bug Fixes

* **pfb_psd_mag_bin-error:** fixed the error caused because of an if statement, also adjusted the position of hover labels ([#46](https://github.com/Ketant0/rfmux/issues/46)) ([2073506](https://github.com/Ketant0/rfmux/commit/207350688bbfd53b997c8db3664ce7e254667ec8))
* **py-get-samples-and-update-noise-plot:** when reference is absolute the value is already in volts, it was converting again, its removed now ([#37](https://github.com/Ketant0/rfmux/issues/37)) ([e19bee3](https://github.com/Ketant0/rfmux/commit/e19bee3734442845261138161eb8e43c16bf0130))


### Documentation

* **In-the-documents-folder:** Added overall description of the repository ([#28](https://github.com/Ketant0/rfmux/issues/28)) ([cc89540](https://github.com/Ketant0/rfmux/commit/cc895404499763e7a899108beed215b5ddde547f))
